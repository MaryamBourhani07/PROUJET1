...
int main() {
    ...
    // 1️⃣ q = n < p → (5 < 9) → vrai → 1
    q = n < p;
    cout << "1) q = n < p --> " << q << endl;

    // 2️⃣ q = n == p → (5 == 9) → faux → 0
    q = n == p;
    cout << "2) q = n == p --> " << q << endl;
    ...
    // 4️⃣ x = p / n → division entière : 9 / 5 = 1
    x = p / n;
    cout << "4) x = p / n --> " << x << endl;

    // 5️⃣ x = (float)p / n → 9.0 / 5 = 1.8
    x = (float)p / n;
    cout << "5) x = (float)p / n --> " << x << endl;

    // 6️⃣ x = (p + 0.5) / n → 9.5 / 5 = 1.9
    x = (p + 0.5) / n;
    cout << "6) x = (p + 0.5) / n --> " << x << endl;

    // 7️⃣ x = (int)(p + 0.5) / n → (int)(9.5) = 9 → 9 / 5 = 1
    x = (int)(p + 0.5) / n;
